		...
		return `
				<form class="login-form" data-submit="${_.componentName}:doFormAction" data-handle="doLogin">
					...
					<div class="form-block">
						...
						<g-input class="g-form-item" type="email"  value="anton@mail.ru" name="email" className="form-input" required></g-input>
					</div>
					<div class="form-block">
						<div class="form-label-row">
							<label class="form-label">Password</label>
						...
						<g-input class="g-form-item" type="password" name="password"  className="form-input"  value="testtest" required></g-input>
					</div>
					<div class="form-block">
